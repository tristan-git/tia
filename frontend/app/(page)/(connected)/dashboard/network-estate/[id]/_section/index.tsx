		...
		<>
			<div className='flex items-center justify-between mb-4'>
				<div className='space-y-1'>
					<h2 className='text-2xl font-semibold tracking-tight'>{`Réseaux : ${rnbCode}`}</h2>
					<p className='text-sm text-muted-foreground'>Gestion des bâtiments de votre Réseaux</p>
				</div>
			...
			{!isManager && (
				<Alert className='mb-6'>
					...
					<AlertDescription className='text-xs'>Vous n'ête pas gestionnaire du bien, vous ne pouvez pas ajouter de bâtiment</AlertDescription>
				</Alert>
			)}
